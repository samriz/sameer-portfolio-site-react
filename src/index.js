...
const IndexPage = () => {
    ...
    main_content={
        <>
            ...
            <ul>
                <li>My <a href="./misc/SameerRizviResume.pdf" title="Resume" target="_blank" rel="author">resume <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" class="bi bi-box-arrow-up-right" viewBox="0 0 16 16">
                ...
                <li>My <a href="https://github.com/samriz" target="_blank" title="GitHub" rel="noreferrer">GitHub</a>.</li>
